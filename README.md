...
## Project Structure
TaskManagement/
├── ProductManagement.Web/          # Web Layer (Controllers, Views)
├── ProductManagement.Application/     # Business Logic (Services, DTOs, Interfaces)
├── ProductManagement.Domain/          # Domain Layer (Entities, Enums)
├── ProductManagement.Infrastructure/  # External Services (JWT, Hashing Service)
├── ProductManagement.Persistence/     # Database Layer (DbContext, Repositories, Seeders)
## Prerequisites
